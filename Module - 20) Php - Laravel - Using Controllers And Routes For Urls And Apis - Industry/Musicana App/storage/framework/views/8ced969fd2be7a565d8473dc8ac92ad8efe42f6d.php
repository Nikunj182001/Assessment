                    ...
                    <div class="container py-5 h-100">
                        ...
                        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                            ...
                            <!-- FORM TAG -->
                                ...
                                <button data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg btn-block" type="submit" id="btn">Login</button>
    ...
    <script>
        $('#btn').click(function(e){
            ...
            else if(name == 'admin')
            {
                ...
                $.ajax({
                            url:"<?php echo e(route('adminpanel')); ?>",
                            type:'get',
                            data:{email:email,
                                pass:pass
                            },
            ...
            else if(name == 'user')
            {
                ...
                $.ajax({
                        url:"<?php echo e(route('userpanel')); ?>",
                        type:'get',
                        data:{email:email,
                            pass:pass
                        },
...
</html><?php /**PATH C:\xampp\htdocs\LARAVEL\CAKE_SHOP\resources\views/admin/index.blade.php ENDPATH**/ ?>