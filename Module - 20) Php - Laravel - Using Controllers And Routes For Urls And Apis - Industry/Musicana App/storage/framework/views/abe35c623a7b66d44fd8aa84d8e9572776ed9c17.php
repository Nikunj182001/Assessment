    ...
    <div class="content-wrapper">
        ...
        <div class="row ">
            <div class="col-12 grid-margin">
                <form class="row g-3" action="<?php echo e(route('updateAlbum', $album->id)); ?>" method="POST"
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="inp1" name="artist_name"
                            value="<?php echo e($album->artist_name); ?>">
                    </div>

                    <div class="col-md-12">
                        <label for="name" class="form-label">Album Name</label>
                        <input type="text" class="form-control" id="inp1" name="album_name"
                            value="<?php echo e($album->album_name); ?>">
                    </div>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LARAVEL\MUSICANA_APP\resources\views/admin/editAlbum.blade.php ENDPATH**/ ?>