                ...
                <nav class="navbar navbar-expand-lg  bg-dark  navbar-dark">
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <?php endif; ?> </span>
                            <span style="background:yellow;margin-right:10px"><a href="<?php echo e(route('userProfile')); ?>"></a><i
                        ...
                        <form action="<?php echo e(route('updateUser', $user->id)); ?>" method="post">
                            ...
                            <div data-mdb-input-init class="form-outline mb-4 px-5">
                                ...
                                <input type="password" id="password" name="password"
                                    class="form-control form-control-lg" value="<?php echo e($user->password); ?>" />
                            </div>
...
</html><?php /**PATH C:\xampp\htdocs\LARAVEL\MUSICANA_APP\resources\views/user/editUserProfile.blade.php ENDPATH**/ ?>