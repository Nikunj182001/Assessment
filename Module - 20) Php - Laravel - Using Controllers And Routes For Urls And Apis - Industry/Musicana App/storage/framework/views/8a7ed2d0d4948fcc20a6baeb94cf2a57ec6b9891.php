                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    <div class="card shadow-2-strong" style="border-radius: 1rem;">
                        <div class="card-body p-2 text-center">
                            ...
                            <form action="<?php echo e(route('otpSend')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                ...
                                <button data-mdb-button-init data-mdb-ripple-init
                                    class="btn btn-primary btn-lg btn-block" type="submit" id="btn">Send</button>

                                <hr class="my-4">

                                <button data-mdb-button-init data-mdb-ripple-init
                                    class="btn btn-lg btn-block btn-primary" style="background-color: #dd4b39;"
                                    type="button"><i class="fab fa-google me-2"></i> Sign
...
</html><?php /**PATH C:\xampp\htdocs\LARAVEL\MUSICANA_APP\resources\views/forgotPage.blade.php ENDPATH**/ ?>