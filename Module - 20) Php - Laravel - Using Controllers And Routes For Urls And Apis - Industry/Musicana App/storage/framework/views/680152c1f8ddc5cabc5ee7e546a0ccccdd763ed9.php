  ...
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="dashboard" style="color:red;">HEXASHOP</a>
          ...
          <div class="profile-desc">
            <div class="profile-pic">
              <div class="count-indicator">
                <img class="img-xs rounded-circle " src="assets/images/faces/IMG20230123125250.jpg" alt="">
                <span class="count bg-success"></span>
              </div>
              <div class="profile-name">
                <h5 class="mb-0 font-weight-normal"><?php if (isset($_SESSION['username'])) {
  echo $_SESSION['username'];
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="manage-user">View users</a></li>
              <li class="nav-item"> <a class="nav-link" href="add-user">Add Users</a></li>
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic1">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="manage-category">View Albums</a></li>
              <li class="nav-item"> <a class="nav-link" href="add-category">Add Albums</a></li>
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic4">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="manage-product">View Songs</a></li>
              <li class="nav-item"> <a class="nav-link" href="add-product">Add Song</a></li>
        ...
        <div class="row ">
          <div class="col-12 grid-margin">
            <div class="card">
                  ...
                  <table class="table" border=1px>
                    <thead>
                      <tr>
                        ...
                        <th style="font-weight:bold; color:white; background:blue;"> Artist Name</th>
                        <th style="font-weight:bold; color:white; background:blue;"> Album Name</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
              ...
              <td><?php echo e($a->artist_name); ?></td>
              <td><?php echo e($a->album_name); ?></td>
...
</html><?php /**PATH C:\xampp\htdocs\LARAVEL\MUSICANA_APP\resources\views/admin/manage_album.blade.php ENDPATH**/ ?>