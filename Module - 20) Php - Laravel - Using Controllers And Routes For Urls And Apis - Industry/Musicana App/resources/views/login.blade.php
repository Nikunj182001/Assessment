                    ...
                    <div class="card shadow-2-strong" style="border-radius: 1rem;">
                        <div class="card-body p-2 text-center">
                            ...
                            <button data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg btn-block"
                                type="button" id="btn">Login</button>

                            <a href="register" data-mdb-ripple-init class="btn btn-info btn-lg btn-block">Register
                            </a>
                            <div>
                                <a href="forgotPage" class="btn btn-success my-3">Forgot Password</a>
                            </div>
                            <hr class="my-4">
                ...
                if (user == 'user') {
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            ...
                            if (res == "true") {
                                window.location.href = "{{route('musicana')}}";
                            }
