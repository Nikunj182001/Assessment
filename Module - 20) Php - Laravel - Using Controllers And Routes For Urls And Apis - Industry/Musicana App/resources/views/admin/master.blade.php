        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                <a class="sidebar-brand brand-logo" href="dashboard"
                    style="color:red;background:lightgreen;font-weight:500">MUSICANA</a>
            ...
            <ul class="nav">
                    ...
                    <div class="profile-desc">
                        <div class="profile-pic">
                            ...
                            <div class="profile-name">
                                <h5 class="mb-0 font-weight-normal">@if (session()->has('adminName'))
                ...
                <li class="nav-item menu-items">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{route('manageUser')}}">View users</a></li>
                ...
                <li class="nav-item menu-items">
                    ...
                    <div class="collapse" id="ui-basic1">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{route('manage_album')}}">View Albums</a>
                            </li>
                            <li class="nav-item"> <a class="nav-link" href="{{route('add_album')}}">Add Albums</a></li>
              ...
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item menu-items">
                    ...
                    <div class="collapse" id="ui-basic4">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{route('manage_song')}}">View Songs</a>
                            </li>
                            <li class="nav-item"> <a class="nav-link" href="{{route('add_song')}}">Add Song</a></li>
