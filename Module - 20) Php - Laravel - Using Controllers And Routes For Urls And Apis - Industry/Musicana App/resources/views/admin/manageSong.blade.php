                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table" border=1px>
                                <thead>
                                    <tr>
                                        <th style="font-weight:bold; color:white; background:blue;"> Song
                                            Name </th>
                                        <th style="font-weight:bold; color:white; background:blue;"> Artist
                                        </th>
                                        <th style="font-weight:bold; color:white; background:blue;"> Action
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($song as $a)
                                        <tr>
                                            <td>{{$a->song_name}}</td>
                                            <td>{{$a->artist_name_fk}}</td>
                                            <td><a href="#" class="btn btn-info">Edit</a>&nbsp;&nbsp;&nbsp;<a
                                                    href="{{route('deleteSong', $a->id)}}" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
